...
Semantic Web technology stack can be thought as a layered graph as shown in ~\ref{fig:SemanticWebStack}\footnote{copy from Dr. Rob Brennan's lecture notes.}
